<template>
  ...
  >
    ...
    <div data-circle-inset class="absolute flex items-center justify-center bg-primary text-white w-12 h-12 rounded-full cursor-pointer -top-6 left-1/2 transform -translate-x-1/2"><i class="t2ico t2ico-plus" @click="goToRoute"></i></div>
  </footer>
</template>
