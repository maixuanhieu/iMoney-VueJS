  ...
  <div class="row">
    <div class="container mx-auto p-8">
      <div class="text-center">
        ...
        <div class="font-bold text-2xl text-primary mt-3">Mon Pham</div>
        <p class="font-semibold text-gray-400 mt-1">mon.pham@gmail.com</p>
      </div>
    </div>
  </div>
      ...
      <div class="grid grid-cols-1">
        <div class="col-span-1">
          <ul>
            <li 
             class="text-dark"
            v-for="(profileOption,index) in profileOptions" :key="profileOption.name"
            >
              <router-link
                :to="profileOption.route"
                class="flex justify-between items-center py-3"
              >
                <div class="flex items-center text-left" :class="{ 'text-red' : index === profileOptions.length - 1 }">
